...
export type ReplayHeadersPolicy = (headers: Headers, operation: OfflineOperation) => void | Promise<void>;
export type ReplayResolutionPolicy = (context: ReplayResolutionContext) => boolean | Promise<boolean>;
